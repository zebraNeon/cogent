...
traversals :: [(MN.Instance VarName, Maybe Int)] -> CS.Definition -> GlDefn t [(CS.Definition, Maybe String)]
...
collect :: GlState -> [TypeName] -> GlueMode -> [FilePath] -> ExceptT String IO (MN.FunMono VarName, MN.TypeMono VarName)
...
analyseFuncId :: [(String, SrcLoc)] -> GlDefn t [(FunName, MN.Instance VarName)]
